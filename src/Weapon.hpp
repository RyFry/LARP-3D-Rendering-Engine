...
struct Weapon {
	Weapon (std::string default_model_path, std::string anim_path, std::string ammo_path, Larp::NodePtr parent_node, GLfloat pitch, GLfloat yaw, GLfloat z)
	{
	...
	void initiate_physics(PhysicsWorld* world)
	{
		PhysicsObjectBuilder<btBoxShape> gun_builder;
   		...
   		gun_builder.set_position(glm::vec3(3.0, 9.0, 0.0));
